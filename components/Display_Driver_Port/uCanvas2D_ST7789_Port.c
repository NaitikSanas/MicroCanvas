...
void ST7789_Init(uCanvas2D_Display_Orientation_t orientation){
    ...
    lcdFillScreen(&st7789_dev_instance,BLACK);
	lcdDrawFinish(&st7789_dev_instance);
...
void ST7789_SetAddressWindow(TFT_t *st7789_dev_instance, int x0, int y0, int x1, int y1) {
    // Column address set
...
void ST7789_PushTile(int x, int y, uCanvas2D_RenderBuffer_t* buf){
    ...
    const int maxPixelsPerChunk = 1024;
    int totalPixels = w * h;
    int sent = 0;
...
void ST7789_Adjust_Brightness(int percent){
